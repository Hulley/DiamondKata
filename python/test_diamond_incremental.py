...
def test_diamondA_has_one_line_containing_a():
	print(diamond.Diamond('A').print_diamond())
	print(diamond.Diamond('B').print_diamond())
...
# this would be a point I would raise with co-workers or the team lead:
# tests like this can cause confusion if the results don't stricly align
# with the test function implied by the name. These following tests return
# a string for one_row. That is, not a list of elements as the name implies.
